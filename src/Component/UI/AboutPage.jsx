...
export default function AboutPage() {
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-10 sm:py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-12">
        {stats.map((stat) => {
          ...
          return (
            <div
              key={stat.label}
              className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-5 shadow-sm text-center transition-colors"
            >
              <div className="w-10 h-10 mx-auto mb-3 bg-orange-50 dark:bg-orange-950/40 text-orange-600 dark:text-orange-400 rounded-xl flex items-center justify-center">
      ...
      {/* Story */}
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm mb-8 transition-colors">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm transition-colors">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-slate-100">Our Mission</h2>
        </div>
        <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
