    ...
    <div className="w-full bg-white/70 backdrop-blur-md border border-slate-200/80 rounded-3xl p-4 sm:p-6 shadow-xl shadow-slate-200/50 mt-[10%]">
      ...
      <div className="flex items-center justify-between mb-5 px-2">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-900 tracking-tight">User History</h2>
              ...
              {usersData.map((user) => {
                return (
                  ...
                  >
                    ...
                    {/* Status Badge Cell */}
                    <Table.Cell className="py-4 px-6">
                      <span className="uppercase inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-600 border border-emerald-200/60">
                        {user.role}
                      </span>
                    </Table.Cell>
                      ...
                      <div className="flex items-center justify-end gap-2">

                        {
                          user.isBlock ? <Button
                            ...
                            size="sm"
                            className="bg-slate-100 hover:bg-green-500 hover:text-white text-slate-700 font-semibold rounded-xl transition-all shadow-sm flex items-center gap-1.5 px-3 py-1.5 text-xs"
                          >
                            ...
                            <Button
                              onClick={() => handleBlock(!user.isBlock,user._id)}
                              size="sm"
                              className="bg-slate-100 hover:bg-red-500 hover:text-white text-slate-700 font-semibold rounded-xl transition-all shadow-sm flex items-center gap-1.5 px-3 py-1.5 text-xs"
                            >
                              <GoBlocked className="w-4 h-4" />
                              <span>Block</span>
                            </Button>
