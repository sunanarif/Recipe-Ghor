            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 sm:px-6 md:flex-row">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a
                        ...
                        aria-label="YouTube"
                        className="rounded-full p-2 text-muted-foreground transition-colors hover:bg-orange-100 hover:text-red-600 dark:hover:bg-orange-950/40"
                    >
                        <svg
                    ...
                    <a
                        ...
                        rel="noopener noreferrer"
                        aria-label="Facebook"
                        className="rounded-full p-2 text-muted-foreground transition-colors hover:bg-orange-100 hover:text-blue-600 dark:hover:bg-orange-950/40"
                    >
                        <svg
                            className="h-5 w-5 fill-current"
                            viewBox="0 0 24 24"
                    ...
                    <a
                        ...
                        className="rounded-full p-2 text-muted-foreground transition-colors hover:bg-orange-100 hover:text-pink-600 dark:hover:bg-orange-950/40"
                    >
                        <svg
                            className="h-5 w-5 fill-current"
                            viewBox="0 0 24 24"
