...
const MyRecipeTable = ({ recipes }) => {
    ...
    return (
        <div className="w-full bg-white/80 backdrop-blur-md border border-slate-200/80 rounded-3xl p-4 sm:p-6 shadow-xl shadow-slate-200/50">
                                            ...
                                            <div className="flex items-center justify-end gap-1.5">
                                                ...
                                                <Tooltip content="View Recipe">
                                                    <Link href={`/recipes/${recipe._id}`}>
                                                        <Button
                                                            size="sm"
                                                            className="w-8 h-8 min-w-0 p-0 bg-slate-100 hover:bg-orange-500 hover:text-white text-slate-600 rounded-xl transition-all shadow-sm flex items-center justify-center"
                                                        >
                                                ...
                                                <Tooltip content="Edit Recipe">
                                                    <Link href={`/dashboard/user/my-recipe/${recipe._id}/edit`}>
                                                        <Button
                                                            size="sm"
                                                            className="w-8 h-8 min-w-0 p-0 bg-slate-100 hover:bg-blue-500 hover:text-white text-slate-600 rounded-xl transition-all shadow-sm flex items-center justify-center"
                                                        >
                                                ...
                                                <Tooltip content="Delete Recipe">
                                                    <Button
                                                        ...
                                                        className="w-8 h-8 min-w-0 p-0 bg-rose-50 hover:bg-rose-500 hover:text-white text-rose-600 rounded-xl transition-all shadow-sm flex items-center justify-center"
                                                    >
