        ...
        <div className="w-full bg-white/80 backdrop-blur-md border border-slate-200/80 rounded-3xl p-4 sm:p-6 shadow-xl shadow-slate-200/50 mt-[10%]">
            ...
            <div className="flex items-center justify-between mb-5 px-2">
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-slate-900 tracking-tight">Transacton</h2>
                                        ...
                                        <Table.Cell className="py-4 px-6 text-right">
                                                {
                                                    ...
                                                    transaction.session_id ?<span className="uppercase inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-600 border border-emerald-200/60"> Paid</span>: <div></div>
                                                }
